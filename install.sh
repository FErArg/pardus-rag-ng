...
install_mcp() {
    echo "[4/8] Instalando servidor MCP (Python)..."
...
install_document_dependencies() {
    echo "[5/8] Instalando librerias de parsing de documentos..."
...
install_sentence_transformers() {
    echo "[6/8] Instalando sentence-transformers (embeddings)..."
...
configure_opencode() {
    echo "[7/8] Configurando OpenCode..."
